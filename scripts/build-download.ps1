# Build FileDock with downloadBootstrapper WebView2 install mode
# Result: small installer (~3MB), downloads bootstrapper at install time
# Requires internet connection during installation if WebView2 is not installed

$ErrorActionPreference = "Stop"
Set-Location -LiteralPath (Split-Path -Parent $PSScriptRoot)

$variant = "downloadBootstrapper"
$config  = "src-tauri/tauri.conf.download.json"
