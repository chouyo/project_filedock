# Build FileDock with skip WebView2 install mode
# Result: smallest installer (~3MB), assumes WebView2 is already installed
# Use this for enterprise deployment where WebView2 is pre-installed

$ErrorActionPreference = "Stop"
Set-Location -LiteralPath (Split-Path -Parent $PSScriptRoot)

$variant = "skip"
$config  = "src-tauri/tauri.conf.skip.json"
